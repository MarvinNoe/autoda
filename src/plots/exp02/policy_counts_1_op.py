...
file_path = "./outputs/experiments/exp04/policy_gen/fastaa_gc10_transforms_1_op/policies_top_10.csv"
required_count = 62
...
def transforms_names():
    ...
    t_names = [t[0].__name__ for t in op_creator.gc10_transform_creators()]
...
plt.tight_layout()
plt.savefig('./plots/exp02_count_1_op.svg')
plt.show()
